    ...
    <div className="chatContainer">
      {fileNotSent && (
        <div className='imageContainer'>
          ...
          <div className="imageText">DocMistral - Your one stop Context Analyzer plus Teacher!</div>
      ...
      {!fileNotSent && (
        ...
        <img src={userIcon} className='chat-user-message-icon' alt="" />
